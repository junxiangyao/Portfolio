...
function setup() {
  ...
  for(let i = 0; i < NUM; ++i){
    list_layout[i] = createVector(windowWidth / 8 + 160, 108 + 52 * i + 50);
  }
...
function draw() {
  ...
  if(mode === 0){ // list layout
    ...
    if((mouseX > (emperors[0].location.x - 24) && mouseX < (emperors[0].location.x + 280)
      && mouseY > 110 && mouseY < 130) || mode_0_sort[0]){
        fill(235,118,107);
    }
    noStroke();
    text("POSTHUMOUS NAME", emperors[0].location.x + 32, 120);
    fill(33);
    if(mouseX > (emperors[0].location.x + 280) && mouseX < (emperors[0].location.x + 480)
      && mouseY > 110 && mouseY < 130 || mode_0_sort[1]){
        fill(235,118,107);
    }
    text("NAME", emperors[0].location.x + 280, 120);
    fill(33);
    if(mouseX > (emperors[0].location.x + 480) && mouseX < (emperors[0].location.x + 600)
      && mouseY > 110 && mouseY < 130 || mode_0_sort[2]){
        fill(235,118,107);
    }
    text("LIFESPAN", emperors[0].location.x + 480, 120);
    fill(33);
    if(mouseX > (emperors[0].location.x + 600) && mouseX < (emperors[0].location.x + 810)
      && mouseY > 110 && mouseY < 130 || mode_0_sort[3]){
        fill(235,118,107);
        if(mouseX > (emperors[0].location.x + 700) && mouseX < (emperors[0].location.x + 810)){
          push();
          translate(emperors[0].location.x + 766, 120);
          if(inverted){
    ...
    text("REIGN", emperors[0].location.x + 600, 120);
    text("ORDER", emperors[0].location.x + 700, 120);
    fill(33);
    for(let i = 0; i < NUM; ++i){
      fill(230);
      if(i%2 === 0){
        rect(emperors[0].location.x - 32, 108 + 52 * i + 25, 810, 52);
